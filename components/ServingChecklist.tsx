...
import { ClipboardList, Users, MapPin, Clock, PlusCircle, MinusCircle, CheckCircle2, Camera, Image as ImageIcon, Loader2, ChevronLeft, X, Edit3, Trash2, Plus, Save, RotateCcw, Settings2 } from 'lucide-react';
...
export const ServingChecklist: React.FC = () => {
  const { 
      ...
      addServingGroup, updateServingGroup, completeServingGroup,
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <div className="flex items-center text-gray-500 text-sm space-x-3 mt-1">
                            ...
                            <span className="flex items-center"><Clock size={14} className="mr-1"/> Vào lúc: {selectedGroup.startTime}</span>
                        </div>
                    </div>
                  </div>
              </div>
                        ...
                        <div className="p-5 space-y-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <input type="time" value={editGroupTime} onChange={(e) => setEditGroupTime(e.target.value)} className="w-full border rounded-lg p-2.5 text-sm outline-none focus:ring-2 focus:ring-teal-500" />
                                </div>
                            </div>
                        </div>
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <button 
            ...
            className="bg-teal-600 text-white px-4 py-2 rounded-lg font-bold shadow-md flex items-center hover:bg-teal-700 transition-colors"
        >
          ...
          {activeGroups.map(group => {
              ...
              return (
                  <div 
                    ...
                    className="bg-white rounded-2xl p-6 shadow-sm border border-gray-200 hover:shadow-md cursor-pointer transition-all group"
                  >
                      ...
                      <h3 className="font-bold text-lg text-gray-900 mb-1 truncate">{group.name}</h3>
      ...
      {/* MODAL: ADD NEW GROUP (REDESIGNED) */}
      {isAddModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
